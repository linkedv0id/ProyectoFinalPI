...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Veteran Typewriter", 3, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 255));
        jLabel1.setText("DvD- RENTAL");

        jLabel2.setText("Tienda ID:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jcTienda, 0, 132, Short.MAX_VALUE))))
                .addGap(55, 55, 55))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        empleados=ControladorPersonal.listadoPersonal("0");
        int tienda,id;
        String nombre,contraseña;
        for(int i=0;i<empleados.size();i++){
            tienda=Integer.parseInt(jcTienda.getSelectedItem().toString());
